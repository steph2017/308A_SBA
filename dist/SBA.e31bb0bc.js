...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"picArrange.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.picArrange = picArrange;
...
function picArrange(_x) {
  return _picArrange.apply(this, arguments);
}
function _picArrange() {
  _picArrange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(deptId) {
    var response, jsonData, idList, picID, picArray, picInfo, i, resPhoto, getPhoto;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch("https://collectionapi.metmuseum.org/public/collection/v1/objects?departmentIds=" + deptId);
        case 2:
        ...
        case 5:
          ...
          // returns an object with a 2 key value pairs - we want the array of values corresponding to "objectIDs"
          idList = jsonData.objectIDs;
          picID = 0;
          picArray = [];
          picInfo = ""; //Attempting to fetch data for 15 ids chosen at random
          i = 0;
        case 11:
          if (!(i < 15)) {
            _context.next = 28;
          ...
          idList[Math.round(Math.random() * (idList.length - 1))], _readOnlyError("picID");
          _context.next = 15;
          return fetch("https://collectionapi.metmuseum.org/public/collection/v1/objects/" + picID);
        case 15:
          resPhoto = _context.sent;
          _context.next = 18;
          return resPhoto.json();
        case 18:
          getPhoto = _context.sent;
...
var _picArrange = require("./picArrange.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
},{"./Carousel.js":"Carousel.js","axios":"node_modules/axios/index.js","./picArrange.js":"picArrange.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/SBA.e31bb0bc.js.map